...
"[project]/data/analises.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/(dashboard)/riscos/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$analises$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/analises.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function RiscosPage() {
    ...
    const data = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RiscosPage.useMemo[data]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$analises$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRiscosMockData"])("30d")
    }["RiscosPage.useMemo[data]"], []);
    const evolucaoRiscosData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RiscosPage.useMemo[evolucaoRiscosData]": ()=>data.evolucaoRiscos.map({
                "RiscosPage.useMemo[evolucaoRiscosData]": (p)=>({
                        label: new Date(p.date).toLocaleDateString("pt-BR", {
                            month: "short"
                        }),
                        value: p.total
                    })
            }["RiscosPage.useMemo[evolucaoRiscosData]"])
    }["RiscosPage.useMemo[evolucaoRiscosData]"], [
        data.evolucaoRiscos
    ]);
    const riscosPorCategoriaData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RiscosPage.useMemo[riscosPorCategoriaData]": ()=>data.riscosPorCategoria.map({
                "RiscosPage.useMemo[riscosPorCategoriaData]": (r)=>({
                        label: r.categoria,
                        value: r.quantidade
                    })
            }["RiscosPage.useMemo[riscosPorCategoriaData]"])
    }["RiscosPage.useMemo[riscosPorCategoriaData]"], [
...
_s(RiscosPage, "8XxLpOMMzn9v9bbt65O6JacvcOk=");
_c = RiscosPage;
var _c;
...
//# sourceMappingURL=_c90591e1._.js.map